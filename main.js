...
imgburger.addEventListener('click', () => {
  imgburger.classList.remove('Hamburger-active');
});
...
const seeproject = document.querySelector('#see-project1');
const seeproject = document.querySelector('#see-project2');
const seeproject = document.querySelector('#see-project3');
